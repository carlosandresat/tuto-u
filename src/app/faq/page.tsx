...
export default function FAQ() {
  return (
    <>
      <StartNavbar />
      <section className="max-w-screen-2xl px-8 translate-y-1/3 md:translate-y-1/2 flex items-center justify-center flex-col">
        <div className="flex flex-col md:flex-row w-full pb-8 md:pb-10">
