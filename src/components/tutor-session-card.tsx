    ...
    <Card>
          ...
          {studentWhatsapp ? (
            <>
              ...
              <p className="break-all">
                <a
                  href={`https://wa.me/${studentWhatsapp.substring(1)}`}
                  target="_blank"
      ...
      <CardFooter className="flex justify-between items-center space-x-2">
        {statusState === "accepted" && rawDateTime > new Date() ? (
          ...
          rawDateTime > addHours(new Date(), 1) ? ( //solo se puede aceptar 1 hora antes
          <>
            <RejectDialog
              setState={setStatusState}
              sessionId={sessionId}
          ...
          rawDateTime < addHours(new Date(), 1) ? ( //solo se puede aceptar 1 hora antes
          <p className="text-center text-destructive leading-4">
            No respondiste a tiempo, vuelve a configurar tu perfil
          </p>
