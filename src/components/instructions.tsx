...
export default function Instructions(){
    return(
        <div className="w-4/5">
            <h2 className="text-center text-3xl mt-12 pb-2 border-b md:w-1/4 mx-auto">Para estudiantes:</h2>
            {students_instructions.map((c,i)=><CardInstruction key={i} img={c.img} inst={c.inst}/>)}
            <h2 className="text-center text-3xl mt-12 pb-2 border-b md:w-1/4 mx-auto" id="tutor">Para tutores:</h2>
            {tutors_instructions.map((c,i)=><CardInstruction key={i} img={c.img} inst={c.inst}/>)}
        </div>
    )
}
